...
<Note>
  The package never stores raw card data. All card information is tokenized and
  stored securely by MercadoPago.
</Note>
...
<Warning>
  Card tokens are obtained using MercadoPago.js on the frontend. Never send raw
...
<Tip>
  This package handles backend operations only. For frontend card tokenization,
  integrate MercadoPago.js separately.
</Tip>
