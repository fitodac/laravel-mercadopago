...
<Steps>
  <Step title="Install the package">
    Install via Composer in your Laravel project ```bash composer require
    fitodac/laravel-mercadopago:^1.0 ```
  </Step>

  <Step title="Configure credentials">
    Add your Mercado Pago credentials to `.env` ```ini
...
<CardGroup cols={2}>
  ...
  <Card title="Handle Webhooks" icon="webhook" href="/guides/handling-webhooks">
