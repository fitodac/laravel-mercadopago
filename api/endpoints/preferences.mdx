...
<Tip>
  **Production Usage**: For production environments, create your own controllers
  that inject the `PreferenceService` and implement your application's
  authentication, authorization, and business logic.
</Tip>

<Warning>
  **Security**: Demo routes are for development and testing only. Never expose
